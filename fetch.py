#!/usr/bin/env python3
"""
Recuperation des codes promo Autodoc depuis shopilo.fr
Sursa: https://shopilo.fr/reductions/auto-doc.fr
"""
...
SHOPILO_URL = "https://shopilo.fr/reductions/auto-doc.fr"
STORE_NAME = "Autodoc"


def fetch_coupons(url=SHOPILO_URL):
    """Renvoie la liste des coupons actifs pour Autodoc depuis shopilo.fr"""
    headers = {
        "User-Agent": "Mozilla/5.0 (compatible; coupon-fetcher/1.0; +https://github.com/shopilo-fr/code-promo-autodoc)"
    }
    try:
